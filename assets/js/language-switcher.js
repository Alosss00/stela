...
const translations = {
    ...
    'add-first-competency': 'Add First Competency',
        ...
        'select-your-company': '-- Select Your Company --',
        'employee-status': 'Employee Status',
        'certificate-status': 'Certification Status',
        'add-or-update-sub-competency-levels': 'Add or update sub competency levels',
        'rejected': 'Rejected',
        ...
        'request-rejection-details': 'Request Rejection Details',
        'employee-code-label': 'Employee Code / ID Badge',
        'ktt-you': 'You',
        'ktt-have-rejected-this-assign-letter': 'have rejected this assign letter.',
        'status-rejected': 'Rejected',
        'status-pending': 'Pending',
        'code': 'Code',
        'no-requests-data': 'No requests data found',
        'remove': 'Remove',
        'total-accepted-letters': 'Total Accepted Letters',
        'total-approved-letters': 'Total Approved Letters',
        'cv-file': 'CV File',
        ...
        'all-requests-section': 'All Requests',
        'all-statuses': 'Select Status',
        'all-scopes': '-- Select Scopes --',
        'all-areas': '-- Select Areas --',
        ...
        'employee-code-label': 'Employee Code / ID Badge:',
        'assign-letter-no-label': 'Assign Letter No.:',
        'rejection-notes-from-ktt': 'KTT Rejection Notes'
    },
    id: {
    ...
    'remove': 'Hapus',
        ...
        'select-your-company': '-- Pilih Perusahaan Anda --',
        'employee-status': 'Status Karyawan',
        'certificate-status': 'Status Sertifikasi',
        'add-or-update-sub-competency-levels': 'Tambah atau perbarui tingkat sub kompetensi',
        'rejected': 'Tidak Disetujui',
        'department-report': 'Laporan Departemen',
        'company-report': 'Laporan Perusahaan',
        'total-requests': 'Total Permohonan',
        'pending-requests': 'Permohonan Menunggu',
        'status-label': 'Status',
        'verification-date': 'Tanggal Verifikasi',
        'request-rejection-details': 'Detail Penolakan Permohonan',
        'employee-code-label': 'Kode Karyawan / ID Badge',
        'ktt-you': 'Anda',
        'ktt-have-rejected-this-assign-letter': 'telah menolak surat penunjukan ini.',
        'status-rejected': 'Tidak Disetujui',
        'status-pending': 'Menunggu',
        'code': 'Kode',
        'no-requests-data': 'Data permohonan tidak ditemukan',
        'remove': 'Hapus',
        'total-accepted-letters': 'Total Surat Disetujui',
        'total-approved-letters': 'Total Surat Disetujui',
        'cv-file': 'File CV',
        'view-certificate': 'Lihat Sertifikat',
        'ktt-loading-data': 'Memuat data...',
        'id-badge': 'ID BADGE',
        'name': 'Nama',
        'position': 'Jabatan',
        'competency-type': 'Jenis Kompetensi',
        ...
        'showing': 'Menampilkan',
        'requests': 'Pengajuan',
        'showing-all': 'Menampilkan semua data',
        'showing-all-data': 'Menampilkan semua data',
        'active-filter': 'Filter Aktif:',
        'status-label': 'Status:',
        'work-scope-label': 'Ruang Lingkup Kerja:',
        ...
        'all-requests-section': 'Seluruh Pengajuan',
        'all-statuses': 'Pilih Status',
        'all-scopes': '-- Pilih Ruang Lingkup --',
        'all-areas': '-- Pilih Area --',
        'request-date': 'Tanggal Pengajuan',
        'verified-date': 'Tanggal Verifikasi',
        'verified-by': 'Diverifikasi Oleh',
        'status-rejected': 'Tidak Disetujui',
        ...
        'rejected-date': 'Tanggal Tidak Disetujui',
        'rejected-by': 'Ditolak Oleh',
        'rejection-notes': 'Catatan Penolakan',
        'certificate-expiration-2-months': 'Kedaluwarsa Sertifikat (<=2 Bulan)',
        'expiring-certs-renew-immediately': 'Berikut daftar karyawan dengan sertifikat yang akan kedaluwarsa dalam <=2 bulan. Harap segera lakukan perpanjangan.',
        'certificate-name': 'Nama Sertifikat',
        'certificate-number': 'Nomor Sertifikat',
        ...
        'very-urgent': 'Sangat Mendesak',
        'warning': 'Peringatan',
        'request-rejection-details': 'Detail Penolakan Pengajuan',
        'assign-letter-rejection-details': 'Detail Penolakan Surat Penunjukan',
        'employee-name-label': 'Nama Karyawan:',
        'employee-code-label': 'Kode Karyawan / ID Badge:',
        'assign-letter-no-label': 'No. Surat Penunjukan:',
