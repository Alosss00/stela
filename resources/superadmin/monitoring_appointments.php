...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'submit') {
    ...
    header("Location: " . BASE_URL . "/resources/superadmin/monitoring_appointments.php");
    exit();
}
                            ...
                            <?php foreach($appointments as $appt): ?>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo BASE_URL; ?>/resources/superadmin/monitoring_appointment_detail.php?id=<?php echo $appt['id']; ?>" class="action-btn" title="View Detail">
