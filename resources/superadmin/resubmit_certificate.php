...
if ($employee_certification_id <= 0) {
    $_SESSION['error_message'] = "Invalid certificate.";header("Location: monitoring_certificates.php");
    exit;
}
...
if ($result->num_rows == 0) {
    ...
    header("Location: monitoring_certificates.php");
    exit;
}
...
?>
<?php require_once dirname(__DIR__) . '/layouts/superadmin_header.php'; ?>
...
<div class="add-employee-container">
    ...
    <div class="page-header-add">
        ...
        <a href="monitoring_certificates.php" class="btn btn-outline-secondary">
...
<div class="form-section">    
    ...
    <div class="form-group">
        ...
        <div class="form-actions">
            <a href="monitoring_certificates.php" class="btn btn-secondary">Cancel</a>
