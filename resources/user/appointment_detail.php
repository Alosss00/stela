    ...
    <div class="appointment-detail-container" style="display: flex; justify-content: center; padding-top: 50px; min-height: 60vh;">
        <div style="max-width: 600px; width: 100%;">
            <div class="alert alert-error" style="padding: 25px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                ...
                <?php $backLink = (isset($_SESSION['role']) && $_SESSION['role'] === 'superadmin') ? BASE_URL . '/resources/superadmin/monitoring_appointments.php' : 'appointments.php'; ?>
...
<div class="appointment-detail-container">
    ...
    <div class="action-buttons">
        <?php $backLink2 = (isset($_SESSION['role']) && $_SESSION['role'] === 'superadmin') ? BASE_URL . '/resources/superadmin/monitoring_appointments.php' : 'appointments.php'; ?>
