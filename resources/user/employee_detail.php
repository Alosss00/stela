...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'add_certificate') {
    ...
    if (!isset($_POST['csrf_token']) || !isset($_SESSION['csrf_token']) || !hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'])) {
        ...
        $emp_check_result = $db->query("SELECT id FROM employees WHERE deleted_at IS NULL AND id = ? AND contractor_company = ?", [$employee_id, $company_name]);
        if (!$emp_check_result) {
...
<div class="employee-detail-container">
    ...
    <div class="action-buttons">
        <?php $backLink2 = (isset($_SESSION['role']) && $_SESSION['role'] === 'superadmin') ? BASE_URL . '/resources/superadmin/monitoring_employees.php' : 'employees.php'; ?>
