...
<div class="reports-container">
        ...
        <div class="card-body-report">
            <?php if ($report_data && $report_data->num_rows > 0): ?>
                <div class="table-responsive">
                    <table class="table-report datatable" style="width: 100% !important; table-layout: fixed !important; width: 100% !important; table-layout: fixed !important;">
                        <thead>
                            <tr>
                                <th class="col-num">#</th>
    ...
    <div class="card-report" id="section-accepted-req">
        ...
        <div class="card-body-report">
            <div class="table-responsive">
                <table class="table-report datatable" style="width: 100% !important; table-layout: fixed !important; width: 100% !important; table-layout: fixed !important;" id="acceptedRequestTable">
                    <thead>
                        <tr>
                            <th class="col-num">#</th>
    ...
    <div class="card-report" id="section-rejected-req">
        ...
        <div class="card-body-report">
            <div class="table-responsive">
                <table class="table-report datatable" style="width: 100% !important; table-layout: fixed !important; width: 100% !important; table-layout: fixed !important;" id="rejectedRequestTable">
                    <thead>
                        <tr>
                            <th class="col-num">#</th>
                            <th class="col-company-detail">Perusahaan</th>
    ...
    <div class="card-report" id="section-waiting-req">
        ...
        <div class="card-body-report">
            <div class="table-responsive">
                <table class="table-report datatable" style="width: 100% !important; table-layout: fixed !important; width: 100% !important; table-layout: fixed !important;" id="waitingRequestTable">
                    <thead>
                        <tr>
                            <th class="col-num">#</th>
                            <th class="col-company-detail">Perusahaan</th>
    ...
    <div class="card-report" id="section-accepted-assign">
        ...
        <div class="card-body-report">
            <div class="table-responsive">
                <table class="table-report table-approved table-with-filters datatable" style="width: 100% !important; table-layout: fixed !important; width: 100% !important; table-layout: fixed !important;" id="approvedTable">
                    <thead>
                        <tr class="header-row">
    ...
    <div class="card-report" id="section-rejected-assign">
        ...
        <div class="card-body-report">
            <div class="table-responsive">
                <table class="table-report table-rejected datatable" style="width: 100% !important; table-layout: fixed !important; width: 100% !important; table-layout: fixed !important;" id="rejectedTable">
                    <thead>
                        <tr>
                            <th class="col-num">#</th>
