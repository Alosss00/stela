    ...
    <div class="card-report">
        ...
        <div class="card-body-report">
            <div class="table-responsive">
                <table class="table-report table-compact-request table-requests" style="width: 100% !important; table-layout: fixed !important; width: 100% !important; table-layout: fixed !important;" id="requestsTable">
                    <thead>
                        <tr>
