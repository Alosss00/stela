                    ...
                    <tbody>
                        <?php if ($accepted_requests_count > 0): ?>
                            ...
                            <tr data-status="verified">
                                <td class="col-employee"><div class="employee-detail"><strong><?php echo htmlspecialchars($row['full_name']); ?></strong><?php if (isset($row['employee_status']) && $row['employee_status'] === 'resign'): ?> <span class="badge badge-danger" style="font-size: 0.7em; margin-left: 5px;">Resigned (<?php echo !empty($row['resign_date']) ? date('d/m/Y', strtotime($row['resign_date'])) : '-'; ?>)</span> <?php endif; ?><span class="emp-code-detail"><?php echo htmlspecialchars($row['department']); ?></span></div></td>
