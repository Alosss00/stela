...
checkPageAccess(['superadmin'], 'manage_companies');
require_once dirname(__DIR__) . '/layouts/superadmin_header.php';
?>
<div class="container-fluid">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold text-dark"><i class="fas fa-building me-2 text-primary"></i> Company Management</h5>
            <button class="btn btn-primary"><i class="fas fa-plus"></i> Add Company</button>
        </div>
        <div class="card-body">
            <p>Module under construction. Companies CRUD.</p>
        </div>
    </div>
</div>
